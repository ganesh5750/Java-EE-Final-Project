<%-- 
    ...
    Created on : Jul 30, 2015, 1:07:51 AM
    Author     : Ganesh
--%>
...
<body>
  <div id="main">	
	<div id="site_content">
	  ...
	  <div id="content">
              <form action="theft" method="post" style="margin-left: 40px" >
              <fieldset class="fieldsetStyle">
                  <legend class="legendStyle">Theft from vehicle</legend>  
                <div class="damageStyle">
                    ...
                    <label for="radio3"> Is the vehicle ignition or steering wheel column damaged?</label>
