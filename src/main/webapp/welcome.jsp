<%-- 
    Document   : welcome
    Created on : Jul 29, 2015, 12:05:11 PM
    Author     : Ganesh Patel
--%>
...
<body>
    <% if(session.getAttribute("username") != null) {
     %>   
     <p style="color:red;text-align: right;padding-right:200px;padding-bottom: 0px; ">Welcome <%= session.getAttribute("username")%><br/> 
    <a href="logout.jsp" style="color:yellow;text-align: right;margin-left: 1000px;">Logout</a></p>
    <% } %> 
  <div id="main">	
      <div id="site_content">
          <div id="site_heading">
	  ...
	  <div id="content">
		...
		<div class="content_text">
		     <a href="damageProperty.jsp"><h3>Damage Property</h3></a>
		...
		<div class="content_text">
		     <a href="damageVehicle.jsp"><h3>Damage to Vehicle</h3></a>
		...
		<div class="content_text">
		      <a href="lostProperty.jsp"><h3>Lost Property</h3></a>
		...
		<div class="content_text">
		      <a href="theft.jsp"><h3>Theft from Vehicle,under $5000</h3></a>
		...
		<div class="content_text">
		      <a href="theft1.jsp"><h3>Theft under $5000</h3></a>
