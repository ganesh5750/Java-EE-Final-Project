 ...
 * @author Ganesh
 */
@WebServlet (name = "lostProperty", urlPatterns= {"/lostProperty"})
public class lostProperty extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lostProperty</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lostProperty at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         Iterator iter=set.iterator();
             ...
             try {
               if(con != null){          
                String query="INSERT INTO lostproperty (username, ques_id1, answer1, ques_id2, answer2, ques_id3, answer3, ques_id4, answer4, ques_id5, answer5, ques_id6, answer6,  ques_id7, answer7,  ques_id8, answer8) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                ...
                response.sendRedirect("lostProperty.jsp");
